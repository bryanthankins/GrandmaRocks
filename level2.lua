...
function new()
    ...
    --Set instructions
    local instructionLabel = display.newText( "LEVEL 2", 22, 5, native.systemFont, 17 )
    ...
    local randomBall = function()
        ...
        imageTable = {}
        for i = 1,6 do
            table.insert( imageTable, "bomb.png" )
        end
        for i = 1,9 do
        ...
        physics.addBody( ball, { density=4.0, friction=0.6, bounce=0.2, radius=33 } )
    ...
    gameTimer = timer.performWithDelay( 1000, randomBall, 14 )
